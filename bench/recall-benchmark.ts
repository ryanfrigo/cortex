...
const TEST_CASES: TestCase[] = [
  // Food / Health
  { query: "What did Ryan eat for breakfast?", expectedKeywords: ["breakfast", "oatmeal", "eggs", "ate", "meal", "food"], namespace: "health", category: "health" },
  { query: "Ryan's morning meal routine", expectedKeywords: ["breakfast", "oatmeal", "eggs", "morning", "meal", "ate"], namespace: "health", category: "health" },
  ...
  // Projects
  { query: "What's the VoiceCharm tech stack?", expectedKeywords: ["voicecharm", "next.js", "convex", "vapi", "stripe"], namespace: "projects", category: "projects" },
  { query: "VoiceCharm architecture and technologies", expectedKeywords: ["voicecharm", "next.js", "convex", "vapi", "twilio"], namespace: "projects", category: "projects" },
  { query: "What is ClawMart?", expectedKeywords: ["clawmart", "marketplace", "x402", "agent"], namespace: "projects", category: "projects" },
  ...
  { query: "What's Perspektiv?", expectedKeywords: ["perspektiv", "ai", "openrouter"], namespace: "projects", category: "projects" },
  ...
  { query: "When did Ryan break up with Anya?", expectedKeywords: ["anya", "breakup", "broke up", "relationship", "split"], category: "personal" },
  { query: "Ryan's relationship history", expectedKeywords: ["relationship", "dating", "girlfriend", "anya", "broke"], category: "personal" },
  ...
  // Factual
  { query: "What's Ryan's address?", expectedKeywords: ["address", "street", "city", "apartment", "san francisco", "sf", "live"], category: "factual" },
  { query: "Ryan's phone number", expectedKeywords: ["phone", "510", "number", "contact"], category: "factual" },
  { query: "What machine does Ryan use?", expectedKeywords: ["macbook", "m2", "mac", "laptop", "machine"], category: "factual" },
  ...
  { query: "automating video creation for social media", expectedKeywords: ["viral", "video", "tiktok", "remotion", "render", "viralmachine"], category: "semantic" },
  ...
  { query: "earning revenue from AI voice products", expectedKeywords: ["voicecharm", "voice", "revenue", "stripe", "subscription", "pricing"], category: "semantic" },
];

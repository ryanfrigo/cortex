...
|-------|-----------|-----------|
| "Kalshi trading bot" | "Building VoiceCharm, Perspektiv.ai, Kalshi trading bot" (0.814) | ✅ Yes |
| "VoiceCharm" | "Project: voicecharm" (0.818) | ✅ Yes |
...
### Medium Priority
5. **Import chunking is too granular** — each bullet point becomes a separate memory. A bullet like "Project: voicecharm" has no useful context without its parent section. Consider keeping section header as prefix.

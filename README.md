...
| `projects/voicecharm` | VoiceCharm-specific memories |
...
```bash
cortex save "Ran 5k in 24:30" --namespace health
cortex save "VoiceCharm uses Vapi" --namespace projects/voicecharm
...
cortex extract meeting-notes.txt --namespace projects/voicecharm
